...
def registration_view(request):
    ...
    if request.method == 'GET':
        localmodel = user_detail.objects.all()
    ...
    if request.method == 'POST':
        ...
        if localserializer.is_valid():
            ...
            localmodels = user_detail.objects.filter(email=emaildata)

            usernamedata = localserializer.data['username']
            localmodelsuser = user_detail.objects.filter(username=usernamedata)
